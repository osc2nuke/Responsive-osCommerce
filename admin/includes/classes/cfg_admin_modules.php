...
*/
  ...
  class cfg_admin_modules {
    ...
    function __construct() {
      ...
      $directory = 'includes/modules/cfg_admin_modules';
        ...
        while ($file = $dir->read()) {
          if (!is_dir($directory . $file)) {
            if (substr($file, strrpos($file, '.')) == $file_extension) {
              ...
              include('includes/languages/' . $language . '/modules/cfg_admin_modules/' . $file);
              include('includes/modules/cfg_admin_modules/' . $class . '.php');
